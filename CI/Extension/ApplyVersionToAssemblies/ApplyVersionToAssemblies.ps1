...
$versionPath = Join-Path $env:BUILD_SOURCESDIRECTORY "version.txt"
Write-Host "Saving version in file $versionPath"
Set-Content -Path $versionPath -Value $NewVersion -Force
